...
<html lang="en">
  ...
  <strong>Welcome to TextParser's</strong> You can do anything with your text :
...
<div class="container">
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Enter your text below and let us do the magic :)</label>
  ...
  <label class="custom-control-label" for="customSwitch3">lowercase</label>
</div>
  <div class="custom-control custom-switch">
  <input type="checkbox" name= 'titlecase'class="custom-control-input" id="customSwitch4">
  <label class="custom-control-label" for="customSwitch4">TitelCase</label>
</div>
  <div class="custom-control custom-switch">
  <input type="checkbox" name= 'extraspaceremover'class="custom-control-input" id="customSwitch5">
  <label class="custom-control-label" for="customSwitch5">Extra space remover</label>
</div>
  <div class="custom-control custom-switch">
  <input type="checkbox" name= 'charcount' class="custom-control-input" id="customSwitch6">
  <label class="custom-control-label" for="customSwitch6">Character counter</label>
</div>
